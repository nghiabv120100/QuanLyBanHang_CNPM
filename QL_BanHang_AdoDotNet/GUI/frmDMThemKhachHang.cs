...
namespace QL_BanHang_AdoDotNet.GUI
{
    ...
    public partial class frmDMThemKhachHang : Form
    {
        public frmDMThemKhachHang()
        {
            InitializeComponent();

        }
        List<KhachHang> dsKH = new List<KhachHang>();
        private void frmDMThemKhachHang_Load(object sender, EventArgs e)
        {
    ...
    (e.KeyChar != '.'))
        ...
        {
            Cons.flag = true;
            Cons.maKH = txtMaKhachHang.Text.Trim();
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            string para = txtTimKiem.Text.Trim().ToLower();
            var FilteredList = from x in dsKH
                               where x.TenKhachHang.ToLower().Contains(para) || x.MaKhachHang.ToLower().Contains(para)
